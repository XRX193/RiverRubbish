...
export const riverSegments = [
  { id: 'SEG-01', code: 'DH-01', name: '东河', area: '上城区', status: '启用', tasks: 34 },
  { id: 'SEG-02', code: 'STH-01', name: '上塘河', area: '拱墅区', status: '启用', tasks: 22 },
  { id: 'SEG-03', code: 'CH-01', name: '长河', area: '滨江区', status: '启用', tasks: 18 },
  { id: 'SEG-04', code: 'JHDY-01', name: '京杭大运河', area: '拱墅区', status: '启用', tasks: 15 },
  { id: 'SEG-05', code: 'YHTH-01', name: '余杭塘河', area: '西湖区', status: '停用', tasks: 9 },
];
...
export const tasks = [
  {
    id: 'RW-20260902-0241',
    segmentId: 'SEG-02', segmentName: '上塘河', location: '文晖桥北侧 120 m',
    category: '危险废弃物疑似', sourceCategory: 'chemical_container', confidence: 0.78,
    risk: '高', priority: '紧急', status: '待核查', stage: '人工复核', reporter: '宋清',
    capturedAt: '2026-09-02 16:22', updatedAt: '3 分钟前', lat: 30.2836, lng: 120.1687,
    ...
    image: '/assets/river-waste-01.jpg',
  },
  {
    id: 'RW-20260902-0238',
    segmentId: 'SEG-01', segmentName: '东河', location: '庆春闸下游 260 m',
    category: '塑料制品', sourceCategory: 'plastic_bottle', confidence: 0.94,
    risk: '高', priority: '紧急', status: '待派单', stage: '分析完成', reporter: '林舟',
    capturedAt: '2026-09-02 15:46', updatedAt: '18 分钟前', lat: 30.2595, lng: 120.1748,
...
export const activities = [
  ...
  { time: '16:18', tone: 'green', title: '京杭大运河处置单提交核验', meta: '周宁 · 2 张清理凭证' },
  { time: '15:59', tone: 'red', title: '长河处置单已逾期', meta: 'RW-20260901-0206 · 逾期 3 小时' },
  { time: '15:46', tone: 'teal', title: '东河分析完成', meta: '13 个目标 · 塑料制品 · 高风险' },
];
